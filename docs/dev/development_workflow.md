...
```mermaid
flowchart TB
    A["/issue-create"] --> RR["/issue-review-ready"]
    RR --> RR2{Approve?}
    RR2 -->|No| RF["/issue-fix-ready"]
    RF --> RR
    RR2 -->|Yes| B["/issue-start"]
    B --> C["/issue-design"]
...
| 1.5. レディネスレビュー | `/issue-review-ready` → `/issue-fix-ready` → `/issue-review-ready` | Issue 本文の品質ゲート通過 |
...
├─────────────────────────────────────────────────────────────────────┤
│ • Issue 本文の記述品質をレビュー（7観点）                           │
│ • APPROVE → Phase 2 へ進む                                         │
│ • RETRY  → /issue-fix-ready → /issue-review-ready を繰り返す       │
└─────────────────────────────────────────────────────────────────────┘
                                  ↓
┌─────────────────────────────────────────────────────────────────────┐
│ Phase 2: 着手                                                       │
