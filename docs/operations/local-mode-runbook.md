...
| type:docs | `docs-maintenance-local.yaml` (Phase 5 で追加) | i-doc-update / i-doc-review / i-doc-fix / i-doc-verify / i-doc-final-check / issue-close |
...
- 移行時に必要な kaji 実装は `draft/design/local-mode/design.md` § 残課題 を
  参照（cache 自動 populate / `kaji sync local-to-github-plan` / PR context
  注入 / GitLabProvider 等）
