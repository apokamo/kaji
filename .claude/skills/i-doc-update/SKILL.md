...
- `python scripts/check_doc_links.py` による全体確認は許可
...
- `docs/dev/workflow_feature_development.md` と workflow/skill 構成が一致しているか
...
```bash
cd [worktree-absolute-path] && python scripts/check_doc_links.py
```
