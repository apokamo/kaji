...
> **重み付けの方針**: 上記追加観点は「その type 特有の情報不足」を検出する目的。共通観点 1〜7・14 が通っていても、追加観点で不足があれば RETRY とする。
...
| status | 条件 |
|--------|------|
| PASS | 共通観点 1〜7・14 と該当 type 追加観点をクリア → 作業着手に進行可 |
...
reason: |
  全チェック観点をクリア
evidence: |
  共通観点1〜7・14と該当type追加観点について、構造・具体性・根拠・検証可能性・1次情報・整合性・スコープ推定・workflow内判定可能性に問題なし
suggestion: |
---END_VERDICT---
```
